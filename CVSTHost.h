...
// no idea how things look here...
	...
	virtual float EffGetVu() { return (float)EffDispatch(DECLARE_VST_DEPRECATED(effGetVu)) / (float)32767.; }
...
#endif
	virtual long EffIdentify() { return EffDispatch(DECLARE_VST_DEPRECATED(effIdentify)); }
	...
	virtual long EffGetNumProgramCategories() { return EffDispatch(DECLARE_VST_DEPRECATED(effGetNumProgramCategories)); }
	...
	virtual long EffCopyProgram(long index) { return EffDispatch(DECLARE_VST_DEPRECATED(effCopyProgram), index); }
	virtual long EffConnectInput(long index, bool state) { return EffDispatch(DECLARE_VST_DEPRECATED(effConnectInput), index, state); }
	virtual long EffConnectOutput(long index, bool state) { return EffDispatch(DECLARE_VST_DEPRECATED(effConnectOutput), index, state); }
	...
	virtual long EffGetCurrentPosition() { return EffDispatch(DECLARE_VST_DEPRECATED(effGetCurrentPosition)); }
	virtual long EffGetDestinationBuffer() { return EffDispatch(DECLARE_VST_DEPRECATED(effGetDestinationBuffer)); }
	...
	virtual long EffSetBlockSizeAndSampleRate(long blockSize, float sampleRate) { return EffDispatch(DECLARE_VST_DEPRECATED(effSetBlockSizeAndSampleRate), 0, blockSize, 0, sampleRate); }
	...
	virtual long EffGetErrorText(char *ptr) { return EffDispatch(DECLARE_VST_DEPRECATED(effGetErrorText), 0, 0, ptr); }
	...
	virtual long EffIdle() { if (bNeedIdle) return EffDispatch(DECLARE_VST_DEPRECATED(effIdle)); else return 0; }
	virtual long EffGetIcon() { return EffDispatch(DECLARE_VST_DEPRECATED(effGetIcon)); }
	virtual long EffSetViewPosition(long x, long y) { return EffDispatch(DECLARE_VST_DEPRECATED(effSetViewPosition), x, y); }
	...
	virtual long EffKeysRequired() { return EffDispatch(DECLARE_VST_DEPRECATED(effKeysRequired)); }
...
public:
	...
	virtual void * OnOpenWindow(DECLARE_VST_DEPRECATED(VstWindow)* window) { return 0; }
	virtual bool OnCloseWindow(DECLARE_VST_DEPRECATED(VstWindow)* window) { return false; }
...
public:
    virtual int LoadPlugin(LPCTSTR lpszName, int nUniqueId = 0);
...
public:
	...
	virtual void * OnOpenWindow(int nEffect, DECLARE_VST_DEPRECATED(VstWindow)* window);
	virtual bool OnCloseWindow(int nEffect, DECLARE_VST_DEPRECATED(VstWindow)* window);
